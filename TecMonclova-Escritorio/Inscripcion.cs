...
namespace TecMonclova_Escritorio
{
    public partial class Inscripcion : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            string idPeriod = x[0];
            consulta = "INSERT INTO Enrollment (numericalReference, totalPayment, matriculation, dueDate, semester, idStudent, idPeriod, idUserCreate, creationDate) VALUES (" + numericalReference + ", " + totalPayment + ", '" + matriculation + "', '" + dueDate + "', " + semester + ", " + idStudent + ", " + idPeriod + ", 1, '2023-12-13')";
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Enrollment SET numericalReference = " + numericalReference + ", totalPayment = " + totalPayment + ", matriculation = '" + matriculation + "', dueDate = '" + dueDate + "', semester = " + semester + ", idStudent = " + idStudent + ", idPeriod = " + idPeriod + " WHERE idEnrollment = " + idEnrollment;
            Conn.ejecutaConsulta(consulta);
            MostrarDatos();
            Limpiar();
        }
